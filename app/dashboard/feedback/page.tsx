              ...
              <div className="grid gap-4 py-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Badge className={getPriorityColor(selectedFeedback.priority)}>{selectedFeedback.priority}</Badge>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm bg-gray-50 p-3 rounded-md">{selectedFeedback.message}</p>
                </div>
